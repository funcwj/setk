...
for dir in train dev test; do
  ...
  for spk in mix; do
    ...
    ./scripts/compute_librosa_spectrogram.sh \
      ...
      --apply-log true \
      $data_dir/$dir/$spk \
      ./exp/make_stft/3spk_upit/$dir/$spk \
      ./stft/3spk_upit/$dir/$spk
  ...
  mkdir -p $data_dir/$dir/{spk1,spk2,spk3}
  if $use_psa; then
    prepare_wav $simu_dir/$dir/spk1 > $data_dir/$dir/spk1/clean.scp 
    prepare_wav $simu_dir/$dir/spk2 > $data_dir/$dir/spk2/clean.scp
    prepare_wav $simu_dir/$dir/spk3 > $data_dir/$dir/spk3/clean.scp
    for spk in spk1 spk2 spk3; do
    ...
    prepare_wav $simu_dir/$dir/spk3 > $data_dir/$dir/spk3/wav.scp
    for spk in spk1 spk2 spk3; do
